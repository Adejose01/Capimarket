...
export default function PrivacyView(): React.JSX.Element {
          ...
          <div className="space-y-12">
            <section>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
                En CapiMercado, la privacidad de nuestros usuarios es
                fundamental. Recopilamos información personal solo cuando es
                estrictamente necesario para brindarte una experiencia
                exclusiva:
              </p>
              <ul className="list-none space-y-3">
                <li className="flex gap-3 text-slate-600 dark:text-slate-400">
                  ...
                  <span>
                    <strong>Google OAuth:</strong> Al iniciar sesión con Google,
                    recopilamos únicamente tu nombre y correo electrónico para
                    la creación y gestión de tu perfil personal.
                  </span>
                </li>
                <li className="flex gap-3 text-slate-600 dark:text-slate-400">
                  <span className="text-emerald-500 font-bold">•</span>
                  <span>
                    <strong>Imágenes de Productos:</strong> Las imágenes
                    cargadas por los vendedores se almacenan en nuestros
                    servidores seguros para su visualización en el marketplace.
                  </span>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Garantizamos que{" "}
                <strong>no vendemos, alquilamos ni compartimos</strong> tus
                datos personales con terceras partes con fines comerciales. Tu
                información se utiliza exclusivamente para la operación técnica
                de la plataforma y la comunicación de soporte oficial.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Utilizamos "cookies" técnicas esenciales y almacenamiento local
                para mantener tu sesión iniciada de forma segura y recordar tus
                preferencias de visualización. Estas tecnologías son necesarias
                para el funcionamiento correcto de tu cuenta y el panel de
                vendedor.
              </p>
            </section>

            {/* Tarjeta de soporte / contacto final */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400">
                      Estamos disponibles para resolver cualquier duda sobre el
                      tratamiento de tu privacidad.
                    </p>
                  </div>
                </div>
