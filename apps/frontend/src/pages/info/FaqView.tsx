...
export default function FaqView(): React.JSX.Element {
  ...
  const faqs: FaqItem[] = [
    {
      ...
      answer:
        "CapiMercado es una plataforma digital e independiente diseñada para que cualquier persona, emprendedor o tienda en Venezuela pueda registrarse y crear su propio catálogo web autogestionable de forma rápida, fluida y completamente gratuita.",
    },
    {
      question: "¿Quiénes somos?",
      answer:
        "Somos una iniciativa independiente, impulsada a pulmón y autofinanciada (bootstrap). No formamos parte de ninguna gran corporación. Creemos firmemente en democratizar el acceso al comercio electrónico local, ofreciendo una alternativa transparente, rápida y sin barreras de entrada para los comercios.",
    },
    {
      question: "¿Cómo funcionamos?",
      answer:
        "Funcionamos bajo un modelo de conexión directa. Te registras, creas tu inventario y la plataforma genera tu catálogo público. Cuando un comprador se interesa por un artículo de tu stock, te contacta directamente para acordar el pago y la entrega. Nosotros no retenemos dinero, no intervenimos en tus transacciones ni cobramos comisiones por tus ventas.",
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <header className="mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 font-medium leading-relaxed">
              Encuentra respuestas rápidas sobre el funcionamiento de la
              plataforma y nuestra filosofía de trabajo.
            </p>
          </header>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between p-6 text-left font-bold text-slate-900 dark:text-white hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors focus:outline-none cursor-pointer"
                  >
                  ...
                  <div
                    className={`transition-all duration-300 ease-in-out overflow-hidden ${
                      isOpen
                        ? "max-h-60 border-t border-slate-100 dark:border-slate-900"
                        : "max-h-0"
                    }`}
                  >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Estamos aquí para ayudarte a configurar tu espacio.
                </p>
              </div>
            </div>
