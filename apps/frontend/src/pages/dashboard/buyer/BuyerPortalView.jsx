        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <button
              ...
              className="text-xs font-bold uppercase tracking-widest text-red-500 hover:text-red-600 transition-colors flex items-center gap-2 px-4 py-2 hover:bg-red-50 rounded-xl"
            >
          ...
          {myStores.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                ...
                className="p-6 border border-slate-900 rounded-2xl hover:bg-slate-50 transition-colors cursor-pointer group flex flex-col items-center justify-center text-center gap-3"
              >
                <Settings
                  size={28}
              ...
              <button
                ...
                className="p-6 border border-slate-100 rounded-2xl hover:border-slate-300 transition-colors cursor-pointer group flex flex-col items-center justify-center text-center gap-3"
              >
            ...
            >
              ...
              <p className="text-xs text-slate-500 max-w-sm mb-2">
                Si eres una tienda de tecnología y deseas publicar aquí, envía
                tu solicitud.
              </p>
