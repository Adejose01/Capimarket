      ...
      <div className="max-w-350 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[450px_1fr] gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              {activeStores.map(s => (
                <div key={s.id} className={`bg-[#111] p-6 rounded-4xl border ${s.status === 'suspended' ? 'border-red-500/30 opacity-70' : 'border-white/5 hover:border-white/10'} flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors group relative overflow-hidden`}>
