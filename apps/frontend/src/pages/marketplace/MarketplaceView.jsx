            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              >
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-white rounded-md sm:rounded-lg flex items-center justify-center group-hover:scale-105 transition-transform">
                  <span className="text-[#050505] font-black text-sm sm:text-lg">
                    C
                  </span>
                </div>
                <span className="text-base sm:text-xl font-extrabold tracking-tight text-white hidden xs:block">
                  CapiMercado
                </span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="text-sm font-bold bg-white text-[#050505] px-6 py-2 rounded-full hover:bg-slate-200 transition-colors shadow-md"
                >
                  Ingresar
                </button>
              )}
            ...
            <div className="md:hidden flex items-center gap-2">
              {!isAuthenticated ? (
                <button
                  ...
                  className="text-xs font-bold bg-white text-[#050505] px-4 py-1.5 rounded-full"
                >
                  Ingresar
                </button>
              ) : (
        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl relative">
            ...
            <p className="text-slate-500 text-sm mb-6">
              Únete al mercado líder. Completa tus datos y te contactaremos para
              verificar tu tienda.
            </p>
            ...
            <form onSubmit={handleApplyToSell} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-slate-900 text-white font-bold py-3 rounded-xl mt-4 hover:bg-slate-800 transition-colors shadow-lg"
              >
                Enviar Solicitud
              </button>
            </form>
        ...
        {isInitialLoading ? (
          ...
          <>
            ...
            <section className="mb-0">
              {activeStore ? (
                <div
                  className="relative overflow-hidden min-h-100 md:min-h-125 flex items-end md:items-center shadow-lg transition-all duration-500 mt-0"
                  style={{
                  ...
                  <div className="relative z-10 px-8 pt-24 pb-10 md:px-16 md:pt-28 w-full max-w-3xl text-white flex flex-col items-center md:items-start">
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mt-4">
                      {activeStore.category &&
                        Array.isArray(activeStore.category) &&
                        activeStore.category.map((catId) => {
                          const cat = categories.find((c) => c.id === catId);
                          if (!cat) return null;
                          ...
                          return (
                            <span
                              key={catId}
                              className="px-3 py-1 bg-white/20 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-wider rounded-full flex items-center gap-2"
                            >
                        ...
                        <span className="flex items-center gap-2">
                          ...
                          {activeStore.maps_url && (
                            <a
                              ...
                              className="ml-1 inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-500 text-white rounded-full text-[9px] font-extrabold hover:bg-emerald-400 transition-colors"
                            >
                              VER EN MAPS
                            </a>
                          )}
                    ...
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mt-3">
                      ...
                      {activeStore.created && (
                        <span className="text-white/50 text-xs font-medium">
                          Miembro desde{" "}
                          {new Date(activeStore.created).toLocaleDateString(
                            "es",
                    ...
                    <div className="flex justify-center md:justify-start gap-4 mt-6">
                      ...
                      {activeStore.facebook && (
                        <a
                          href={
                            activeStore.facebook.startsWith("http")
                              ? activeStore.facebook
                              : `https://facebook.com/${activeStore.facebook}`
                          }
                          target="_blank"
                          rel="noreferrer"
                          className="text-white hover:text-blue-400 transition bg-white/10 hover:bg-white/20 p-3 rounded-full backdrop-blur-md"
                        >
                    ...
                    {filteredStores?.map((s) => (
                      ...
                      >
                        <div
                          ...
                          style={{
                            backgroundColor: s.primaryColor || "#0f172a",
                          }}
                        ></div>
                        ...
                        <div className="w-16 h-16 rounded-xl flex items-center justify-center text-2xl font-black bg-slate-50 text-slate-900 overflow-hidden z-10 border border-slate-100">
                          {s.logo ? (
                            <SafeImage
                              src={getImageUrl(s, s.logo, "100x100")}
                              alt={s.name}
                        ...
                        <div className="z-10 flex-1">
                          ...
                          <div className="flex gap-1.5 flex-wrap">
                            {(() => {
                              const catIds = Array.isArray(s.category)
                                ? s.category
                                : s.category
                                  ? [s.category]
                                  : [];
