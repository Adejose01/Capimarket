    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans">
      ...
      >
        ...
        <div className="sticky top-0 z-40 flex items-center justify-between px-6 py-4 bg-white/90 dark:bg-[#0a0a0a]/90 backdrop-blur-md border-b border-slate-100 dark:border-white/5">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-sm font-semibold tracking-wide text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors"
          >
            <ArrowLeft size={16} /> Volver
          </button>
          <button
            onClick={() => navigate(-1)}
            className="p-2 text-slate-400 hover:text-slate-900 dark:hover:text-white bg-slate-50 dark:bg-white/5 rounded-full hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
          >
            <X size={20} />
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="mb-8 flex items-baseline gap-2">
                ...
                />
                <span className="text-xl text-slate-500 font-bold ml-4">
                  USDT
                </span>
              </div>
