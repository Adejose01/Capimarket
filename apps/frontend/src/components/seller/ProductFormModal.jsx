...
export default function ProductFormModal({ product, selectedStoreId, onClose, onSuccess }) {
  ...
  const content = (
    <div className={`bg-white ${isModal ? 'rounded-4xl p-8 md:p-10 w-full max-w-2xl shadow-2xl relative max-h-[90vh] overflow-y-auto no-scrollbar border border-slate-100' : 'rounded-4xl p-8 border border-slate-100 max-w-4xl mx-auto md:p-12 shadow-premium animate-in fade-in duration-300'}`}>
